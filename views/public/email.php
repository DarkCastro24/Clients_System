...
Login_Page::headerTemplatePublic('Recuperar Contraseña | Clientes');
?>
...
<div class="container">
    ...
    <div class="login-container">
        <form method="post" id="email-form">
            <img class="Avatar" style="transform: scale(2.4); margin-bottom: 40px;" src="../../resources/img/utilities/mail.png" alt="">
            <h2>Recuperación</h2>
            <!-- INPUTS -->
            ...
            <div style="display: flex; justify-content:center">
                <a onclick="enviarCorreo()" class="btn">
